...
class Ui_Addcheckbox(object):
    def setupUi(self, Addcheckbox):
        ...
        Addcheckbox.resize(300, 180)
        Addcheckbox.setMinimumSize(QtCore.QSize(300, 180))
        Addcheckbox.setMaximumSize(QtCore.QSize(320, 16777215))
        font = QtGui.QFont()
...
"}")
        ...
        self.ck_submitButton = QtWidgets.QPushButton(Addcheckbox)
        ...
        self.ck_cancelButton = QtWidgets.QPushButton(Addcheckbox)
