...
class Ui_infoWindow(object):
    def setupUi(self, infoWindow):
        ...
        infoWindow.resize(350, 100)
        infoWindow.setMinimumSize(QtCore.QSize(350, 100))
        infoWindow.setMaximumSize(QtCore.QSize(350, 100))
        font = QtGui.QFont()
        ...
        self.iw_label_2.setPixmap(QtGui.QPixmap(_fromUtf8(self.progPath + "/icons/info_icon.png")))
        ...
        self.iw_label_1.setMinimumSize(QtCore.QSize(241, 120))
        self.iw_label_1.setMaximumSize(QtCore.QSize(241, 16777215))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8(self.progPath + "Droid Sans Fallback"))
        font.setPointSize(10)
        font.setBold(False)
