...
class Ui_presaveWindow(object):
    def setupUi(self, presaveWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("icons/warning_icon.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.iw_label_2.setPixmap(QtGui.QPixmap(_fromUtf8("icons/warning_icon.png")))
