...
class Ui_aboutStandard(object):
    def setupUi(self, aboutStandard):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(self.progPath + "/icons/xml_icon.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.aw_label_2.setPixmap(QtGui.QPixmap(_fromUtf8(self.progPath + "/icons/xml_icon.png")))
