...
"}")
    ...
    def retranslateUi(self, apiWindow):
        ...
        self.iw_label_1.setText(_translate("apiWindow", "<html><head/><body><p align=\"justify\">Since version 1.3.0, ASMM is now directly connected to the EUFAR database through an API. It will load automatically project data, aicraft data and operators data. The list of operators and aircraft in ASMM is now automatically updated from the EUFAR database. </p><p align=\"justify\">The <span style=\" font-weight:600;\">Project acronym TextBox</span> has been replaced by a <span style=\" font-weight:600;\">SuggestBox</span>. Just write the first letters of a project acronym, and ASMM will list you all projects including those letters. Then just select a project in the list, and the relevant fields will be automatically filled in.</p><p align=\"justify\">Because of the structure of the EUFAR database, in ASMM, only the following fields will be automatically filled in: Project acronym, Mission scientist, Operator and Platform/Aircraft.</p></body></html>"))
