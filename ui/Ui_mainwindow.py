...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1069, 530))
...
"}")
        ...
        self.gridLayout_4.addWidget(self.location_lb, 5, 0, 1, 1)
        ...
        self.location_cb.setMinimumSize(QtCore.QSize(180, 27))
        self.location_cb.setMaximumSize(QtCore.QSize(180, 27))
        font = QtGui.QFont()
        font.setFamily("fonts/SourceSansPro-Regular.ttf")
        font.setPointSize(9)
        font.setBold(False)
...
"}")
        ...
        self.gridLayout_4.addLayout(self.horizontalLayout_76, 5, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.operator_lb, 6, 0, 1, 1)
        ...
        self.operator_cb.setMinimumSize(QtCore.QSize(180, 27))
        self.operator_cb.setMaximumSize(QtCore.QSize(180, 27))
        font = QtGui.QFont()
        font.setFamily("fonts/SourceSansPro-Regular.ttf")
        font.setPointSize(9)
        font.setBold(False)
...
"}")
        ...
        self.horizontalLayout_74.addItem(spacerItem16)
...
"}")
        ...
        self.newOperator_ln.setMinimumSize(QtCore.QSize(180, 27))
        self.newOperator_ln.setMaximumSize(QtCore.QSize(180, 27))
        font = QtGui.QFont()
        font.setFamily("fonts/SourceSansPro-Regular.ttf")
        font.setPointSize(9)
        font.setBold(False)
...
"}")
        ...
        self.newCountry_lb = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.newCountry_lb.setMinimumSize(QtCore.QSize(0, 27))
        self.newCountry_lb.setMaximumSize(QtCore.QSize(16777215, 27))
        font = QtGui.QFont()
        font.setFamily("fonts/SourceSansPro-Regular.ttf")
        font.setPointSize(10)
        font.setBold(False)
        ...
        font.setKerning(True)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        self.newCountry_lb.setFont(font)
        self.newCountry_lb.setObjectName("newCountry_lb")
        self.horizontalLayout_74.addWidget(self.newCountry_lb)
        spacerItem20 = QtWidgets.QSpacerItem(10, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_74.addItem(spacerItem20)
        self.newCountry_cb = QtWidgets.QComboBox(self.scrollAreaWidgetContents)
        self.newCountry_cb.setEnabled(True)
        self.newCountry_cb.setMinimumSize(QtCore.QSize(180, 27))
        self.newCountry_cb.setMaximumSize(QtCore.QSize(180, 27))
        font = QtGui.QFont()
        font.setFamily("fonts/SourceSansPro-Regular.ttf")
        font.setPointSize(9)
        font.setBold(False)
        ...
        font.setKerning(True)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        self.newCountry_cb.setFont(font)
        self.newCountry_cb.setStyleSheet("QComboBox {\n"
"    border: 1px solid #acacac;\n"
"    border-radius: 1px;\n"
"    padding-left: 5px;\n"
"    background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, \n"
...
"    margin: 5px 5px 5px 5px;\n"
"}")
        self.newCountry_cb.setFrame(False)
        self.newCountry_cb.setObjectName("newCountry_cb")
        self.horizontalLayout_74.addWidget(self.newCountry_cb)
        spacerItem21 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_74.addItem(spacerItem21)
        self.gridLayout_4.addLayout(self.horizontalLayout_74, 6, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.aircraft_lb, 7, 0, 1, 1)
        ...
        self.aircraft_cb.setMinimumSize(QtCore.QSize(180, 27))
        self.aircraft_cb.setMaximumSize(QtCore.QSize(180, 27))
        font = QtGui.QFont()
        font.setFamily("fonts/SourceSansPro-Regular.ttf")
        font.setPointSize(9)
        font.setBold(False)
...
"}")
        ...
        self.newAircraft_ln.setMinimumSize(QtCore.QSize(180, 27))
        self.newAircraft_ln.setMaximumSize(QtCore.QSize(180, 27))
        font = QtGui.QFont()
        font.setFamily("fonts/SourceSansPro-Regular.ttf")
        font.setPointSize(9)
        font.setBold(False)
...
"}")
        ...
        self.newRegistration_lb = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.newRegistration_lb.setMinimumSize(QtCore.QSize(0, 27))
        self.newRegistration_lb.setMaximumSize(QtCore.QSize(16777215, 27))
        font = QtGui.QFont()
        font.setFamily("fonts/SourceSansPro-Regular.ttf")
        font.setPointSize(10)
        font.setBold(False)
        ...
        font.setKerning(True)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        self.newRegistration_lb.setFont(font)
        self.newRegistration_lb.setObjectName("newRegistration_lb")
        self.horizontalLayout_75.addWidget(self.newRegistration_lb)
        spacerItem26 = QtWidgets.QSpacerItem(10, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_75.addItem(spacerItem26)
        self.newRegistration_ln = QtWidgets.QLineEdit(self.scrollAreaWidgetContents)
        self.newRegistration_ln.setEnabled(True)
        self.newRegistration_ln.setMinimumSize(QtCore.QSize(100, 27))
        self.newRegistration_ln.setMaximumSize(QtCore.QSize(100, 27))
        font = QtGui.QFont()
        font.setFamily("fonts/SourceSansPro-Regular.ttf")
        font.setPointSize(9)
        font.setBold(False)
        ...
        font.setKerning(True)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        self.newRegistration_ln.setFont(font)
        self.newRegistration_ln.setStyleSheet("QLineEdit {\n"
"    border-radius: 3px;\n"
"   padding: 1px 4px 1px 4px;\n"
"    background-color:  rgb(240, 240, 240);\n"
"}")
        self.newRegistration_ln.setText("")
        self.newRegistration_ln.setFrame(False)
        self.newRegistration_ln.setObjectName("newRegistration_ln")
        self.horizontalLayout_75.addWidget(self.newRegistration_ln)
        spacerItem27 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_75.addItem(spacerItem27)
        self.gridLayout_4.addLayout(self.horizontalLayout_75, 7, 1, 1, 1)
        self.newManufacturer_lb = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.newManufacturer_lb.setMinimumSize(QtCore.QSize(0, 27))
        self.newManufacturer_lb.setMaximumSize(QtCore.QSize(16777215, 27))
        font = QtGui.QFont()
        font.setFamily("fonts/SourceSansPro-Regular.ttf")
        font.setPointSize(10)
        font.setBold(False)
        ...
        font.setKerning(True)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        self.newManufacturer_lb.setFont(font)
        self.newManufacturer_lb.setObjectName("newManufacturer_lb")
        self.gridLayout_4.addWidget(self.newManufacturer_lb, 8, 0, 1, 1)
        self.horizontalLayout_9 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_9.setObjectName("horizontalLayout_9")
        self.newManufacturer_ln = QtWidgets.QLineEdit(self.scrollAreaWidgetContents)
        self.newManufacturer_ln.setEnabled(True)
        self.newManufacturer_ln.setMinimumSize(QtCore.QSize(400, 27))
        self.newManufacturer_ln.setMaximumSize(QtCore.QSize(400, 27))
        font = QtGui.QFont()
        font.setFamily("fonts/SourceSansPro-Regular.ttf")
        font.setPointSize(9)
        font.setBold(False)
        ...
        font.setKerning(True)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        self.newManufacturer_ln.setFont(font)
        self.newManufacturer_ln.setStyleSheet("QLineEdit {\n"
"    border-radius: 3px;\n"
"   padding: 1px 4px 1px 4px;\n"
"    background-color:  rgb(240, 240, 240);\n"
"}")
        self.newManufacturer_ln.setText("")
        self.newManufacturer_ln.setFrame(False)
        self.newManufacturer_ln.setObjectName("newManufacturer_ln")
        self.horizontalLayout_9.addWidget(self.newManufacturer_ln)
        spacerItem28 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_9.addItem(spacerItem28)
        self.gridLayout_4.addLayout(self.horizontalLayout_9, 8, 1, 1, 1)
        self.gridLayout_28.addLayout(self.gridLayout_4, 1, 1, 1, 2)
        spacerItem29 = QtWidgets.QSpacerItem(172, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_28.addItem(spacerItem29, 1, 3, 1, 1)
        spacerItem30 = QtWidgets.QSpacerItem(20, 149, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_28.addItem(spacerItem30, 2, 2, 1, 1)
...
"}")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 1069, 530))
...
"}")
        ...
        self.horizontalLayout_53.addItem(spacerItem33)
...
"}")
        ...
        self.horizontalLayout_53.addItem(spacerItem34)
...
"}")
        ...
        self.horizontalLayout_78.addItem(spacerItem35)
...
"}")
        ...
        self.horizontalLayout_78.addItem(spacerItem36)
...
"}")
        ...
        spacerItem39 = QtWidgets.QSpacerItem(454, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_29.addItem(spacerItem39, 1, 3, 1, 1)
        spacerItem40 = QtWidgets.QSpacerItem(20, 354, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_29.addItem(spacerItem40, 2, 1, 1, 1)
...
"}")
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 988, 534))
        ...
        spacerItem51 = QtWidgets.QSpacerItem(18, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.horizontalLayout_83.addItem(spacerItem52)
        ...
        self.horizontalLayout_83.addItem(spacerItem53)
        ...
        self.horizontalLayout_84.addItem(spacerItem54)
        ...
        self.horizontalLayout_84.addItem(spacerItem55)
        ...
        spacerItem62 = QtWidgets.QSpacerItem(13, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        ...
        self.horizontalLayout_85.addItem(spacerItem66)
        ...
        spacerItem70 = QtWidgets.QSpacerItem(20, 17, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_2.addItem(spacerItem70)
        ...
        self.horizontalLayout_92.addItem(spacerItem71)
        ...
        spacerItem75 = QtWidgets.QSpacerItem(13, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        ...
        self.horizontalLayout_88.addItem(spacerItem77)
        ...
        self.horizontalLayout_88.addItem(spacerItem78)
        ...
        self.horizontalLayout_89.addItem(spacerItem80)
        ...
        self.horizontalLayout_90.addItem(spacerItem81)
        ...
        self.horizontalLayout_90.addItem(spacerItem82)
        ...
        self.horizontalLayout_91.addItem(spacerItem83)
        ...
        self.horizontalLayout_91.addItem(spacerItem84)
        self.verticalLayout.addLayout(self.horizontalLayout_91)
        spacerItem85 = QtWidgets.QSpacerItem(20, 17, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
...
"}")
        ...
        spacerItem89 = QtWidgets.QSpacerItem(13, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
...
"}")
        ...
        spacerItem91 = QtWidgets.QSpacerItem(20, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.verticalLayout_4.addItem(spacerItem91)
...
"}")
        ...
        spacerItem93 = QtWidgets.QSpacerItem(6, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_6.addItem(spacerItem93, 2, 3, 1, 1)
        spacerItem94 = QtWidgets.QSpacerItem(28, 47, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_6.addItem(spacerItem94, 3, 2, 1, 1)
...
"}")
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 959, 489))
        self.scrollAreaWidgetContents_4.setObjectName("scrollAreaWidgetContents_4")
        self.gridLayout_17 = QtWidgets.QGridLayout(self.scrollAreaWidgetContents_4)
        self.gridLayout_17.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_17.setObjectName("gridLayout_17")
        spacerItem95 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.gridLayout_17.addItem(spacerItem95, 0, 1, 1, 1)
        ...
        self.horizontalLayout_50.addItem(spacerItem97)
        ...
        spacerItem100 = QtWidgets.QSpacerItem(13, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_51.addItem(spacerItem100)
...
"}")
        ...
        spacerItem101 = QtWidgets.QSpacerItem(20, 5, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
...
"}")
        ...
        self.horizontalLayout_49.addItem(spacerItem103)
...
"}")
        ...
        spacerItem104 = QtWidgets.QSpacerItem(20, 5, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.verticalLayout_41.addItem(spacerItem104)
...
"}")
        ...
        spacerItem105 = QtWidgets.QSpacerItem(10, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
...
"}")
        ...
        self.horizontalLayout_47.addItem(spacerItem107)
...
"}")
        ...
        spacerItem108 = QtWidgets.QSpacerItem(10, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_47.addItem(spacerItem108)
...
"}")
        ...
        spacerItem109 = QtWidgets.QSpacerItem(10, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_47.addItem(spacerItem109)
...
"}")
        ...
        spacerItem110 = QtWidgets.QSpacerItem(20, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.verticalLayout_46.addItem(spacerItem110)
        self.horizontalLayout_48 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_48.setObjectName("horizontalLayout_48")
        spacerItem111 = QtWidgets.QSpacerItem(13, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_48.addItem(spacerItem111)
...
"}")
        ...
        spacerItem112 = QtWidgets.QSpacerItem(13, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_48.addItem(spacerItem112)
        ...
        self.verticalLayout_59.addItem(spacerItem113)
        ...
        self.horizontalLayout_54.addItem(spacerItem114)
        ...
        self.horizontalLayout_17.addItem(spacerItem115)
        ...
        self.horizontalLayout_17.addItem(spacerItem116)
...
"}")
        ...
        self.verticalLayout_59.addItem(spacerItem117)
...
"}")
        ...
        spacerItem119 = QtWidgets.QSpacerItem(13, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
...
"}")
        ...
        self.horizontalLayout_62.addItem(spacerItem120)
        ...
        spacerItem121 = QtWidgets.QSpacerItem(20, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.verticalLayout_59.addItem(spacerItem121)
        ...
        spacerItem122 = QtWidgets.QSpacerItem(20, 18, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_9.addItem(spacerItem122)
...
"}")
        ...
        spacerItem123 = QtWidgets.QSpacerItem(38, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_17.addItem(spacerItem123, 2, 3, 1, 1)
        spacerItem124 = QtWidgets.QSpacerItem(20, 30, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_17.addItem(spacerItem124, 3, 2, 1, 1)
...
"}")
        ...
        self.scrollAreaWidgetContents_6.setGeometry(QtCore.QRect(0, 0, 1057, 413))
        ...
        spacerItem127 = QtWidgets.QSpacerItem(10, 10, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_20.addItem(spacerItem127)
        ...
        spacerItem128 = QtWidgets.QSpacerItem(10, 10, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem129 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem130 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_21.addItem(spacerItem130)
        ...
        spacerItem131 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_21.addItem(spacerItem131)
...
"}")
        ...
        spacerItem133 = QtWidgets.QSpacerItem(20, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.verticalLayout_61.addItem(spacerItem133)
        ...
        self.horizontalLayout_63.addItem(spacerItem134)
...
"}")
        ...
        spacerItem135 = QtWidgets.QSpacerItem(13, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_63.addItem(spacerItem135)
...
"}")
        ...
        self.horizontalLayout_63.addItem(spacerItem136)
        ...
        spacerItem137 = QtWidgets.QSpacerItem(20, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.verticalLayout_61.addItem(spacerItem137)
        ...
        spacerItem138 = QtWidgets.QSpacerItem(20, 18, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_47.addItem(spacerItem138)
...
"}")
        ...
        spacerItem139 = QtWidgets.QSpacerItem(3, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_33.addItem(spacerItem139, 1, 3, 1, 1)
        spacerItem140 = QtWidgets.QSpacerItem(20, 105, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_33.addItem(spacerItem140, 2, 2, 1, 1)
...
"}")
        ...
        self.scrollAreaWidgetContents_7.setGeometry(QtCore.QRect(0, 0, 1062, 352))
        ...
        self.gridLayout_34.addItem(spacerItem141, 0, 1, 1, 1)
        spacerItem142 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_34.addItem(spacerItem142, 1, 0, 1, 1)
        ...
        self.horizontalLayout_23.addItem(spacerItem143)
        ...
        spacerItem144 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_23.addItem(spacerItem144)
        ...
        spacerItem145 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_23.addItem(spacerItem145)
...
"}")
        ...
        self.verticalLayout_62.addItem(spacerItem146)
        ...
        self.horizontalLayout_64.addItem(spacerItem147)
...
"}")
        ...
        spacerItem148 = QtWidgets.QSpacerItem(13, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_64.addItem(spacerItem148)
...
"}")
        ...
        self.horizontalLayout_64.addItem(spacerItem149)
        ...
        spacerItem150 = QtWidgets.QSpacerItem(20, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.verticalLayout_62.addItem(spacerItem150)
        ...
        spacerItem151 = QtWidgets.QSpacerItem(20, 18, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_49.addItem(spacerItem151)
...
"}")
        ...
        spacerItem152 = QtWidgets.QSpacerItem(8, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_34.addItem(spacerItem152, 2, 3, 1, 1)
        spacerItem153 = QtWidgets.QSpacerItem(20, 36, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_34.addItem(spacerItem153, 3, 2, 1, 1)
...
"}")
        ...
        self.scrollAreaWidgetContents_8.setGeometry(QtCore.QRect(0, 0, 909, 345))
        ...
        self.gridLayout_35.addItem(spacerItem154, 0, 2, 1, 1)
        spacerItem155 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_35.addItem(spacerItem155, 1, 0, 1, 1)
        ...
        self.horizontalLayout_25.addItem(spacerItem156)
        ...
        self.horizontalLayout_25.addItem(spacerItem157)
        ...
        self.horizontalLayout_25.addItem(spacerItem158)
        ...
        spacerItem159 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_25.addItem(spacerItem159)
...
"}")
        ...
        spacerItem160 = QtWidgets.QSpacerItem(20, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.verticalLayout_63.addItem(spacerItem160)
        ...
        self.horizontalLayout_65.addItem(spacerItem161)
...
"}")
        ...
        spacerItem162 = QtWidgets.QSpacerItem(13, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_65.addItem(spacerItem162)
...
"}")
        ...
        self.horizontalLayout_65.addItem(spacerItem163)
        ...
        spacerItem164 = QtWidgets.QSpacerItem(20, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.verticalLayout_63.addItem(spacerItem164)
        ...
        spacerItem165 = QtWidgets.QSpacerItem(20, 18, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
...
"}")
        ...
        spacerItem166 = QtWidgets.QSpacerItem(8, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_35.addItem(spacerItem166, 2, 3, 1, 1)
        spacerItem167 = QtWidgets.QSpacerItem(20, 175, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_35.addItem(spacerItem167, 3, 1, 1, 1)
...
"}")
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QtCore.QRect(0, 0, 909, 345))
        self.scrollAreaWidgetContents_5.setObjectName("scrollAreaWidgetContents_5")
        self.gridLayout_32 = QtWidgets.QGridLayout(self.scrollAreaWidgetContents_5)
        self.gridLayout_32.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_32.setObjectName("gridLayout_32")
        spacerItem168 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.gridLayout_32.addItem(spacerItem168, 0, 1, 1, 1)
        spacerItem169 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_32.addItem(spacerItem169, 1, 0, 1, 1)
        ...
        self.horizontalLayout_27.addItem(spacerItem170)
        ...
        self.horizontalLayout_27.addItem(spacerItem172)
        ...
        spacerItem173 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_27.addItem(spacerItem173)
...
"}")
        ...
        spacerItem174 = QtWidgets.QSpacerItem(20, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.verticalLayout_44.addItem(spacerItem174)
        ...
        self.horizontalLayout_66.addItem(spacerItem175)
...
"}")
        ...
        spacerItem176 = QtWidgets.QSpacerItem(13, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_66.addItem(spacerItem176)
...
"}")
        ...
        self.horizontalLayout_66.addItem(spacerItem177)
        ...
        spacerItem178 = QtWidgets.QSpacerItem(20, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.verticalLayout_44.addItem(spacerItem178)
        ...
        spacerItem179 = QtWidgets.QSpacerItem(20, 18, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_53.addItem(spacerItem179)
...
"}")
        ...
        spacerItem180 = QtWidgets.QSpacerItem(152, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_32.addItem(spacerItem180, 2, 3, 1, 1)
        spacerItem181 = QtWidgets.QSpacerItem(20, 277, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_32.addItem(spacerItem181, 3, 2, 1, 1)
...
"}")
        ...
        self.scrollAreaWidgetContents_9.setGeometry(QtCore.QRect(0, 0, 909, 351))
        ...
        spacerItem182 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.gridLayout_36.addItem(spacerItem182, 0, 1, 1, 1)
        spacerItem183 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_36.addItem(spacerItem183, 1, 0, 1, 1)
        ...
        self.horizontalLayout_32.addItem(spacerItem184)
        self.verticalLayout_25.addLayout(self.horizontalLayout_32)
        self.horizontalLayout_30 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_30.setObjectName("horizontalLayout_30")
        spacerItem185 = QtWidgets.QSpacerItem(10, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_30.addItem(spacerItem185)
        ...
        spacerItem186 = QtWidgets.QSpacerItem(15, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_30.addItem(spacerItem186)
        ...
        spacerItem187 = QtWidgets.QSpacerItem(10, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_29.addItem(spacerItem187)
        ...
        self.horizontalLayout_29.addItem(spacerItem188)
        ...
        self.horizontalLayout_31.addItem(spacerItem189)
        ...
        spacerItem190 = QtWidgets.QSpacerItem(20, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_26.addItem(spacerItem190)
        ...
        self.horizontalLayout_31.addItem(spacerItem191)
        ...
        spacerItem192 = QtWidgets.QSpacerItem(20, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_65.addItem(spacerItem192)
        ...
        self.horizontalLayout_31.addItem(spacerItem193)
...
"}")
        ...
        spacerItem194 = QtWidgets.QSpacerItem(20, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.verticalLayout_68.addItem(spacerItem194)
        ...
        self.horizontalLayout_67.addItem(spacerItem195)
...
"}")
        ...
        spacerItem196 = QtWidgets.QSpacerItem(13, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_67.addItem(spacerItem196)
...
"}")
        ...
        self.horizontalLayout_67.addItem(spacerItem197)
        ...
        spacerItem198 = QtWidgets.QSpacerItem(20, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.verticalLayout_68.addItem(spacerItem198)
        ...
        self.verticalLayout_27.addItem(spacerItem199)
...
"}")
        ...
        spacerItem200 = QtWidgets.QSpacerItem(8, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_36.addItem(spacerItem200, 1, 3, 1, 1)
        spacerItem201 = QtWidgets.QSpacerItem(20, 169, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_36.addItem(spacerItem201, 2, 2, 1, 1)
...
"}")
        ...
        self.scrollAreaWidgetContents_10.setGeometry(QtCore.QRect(0, 0, 909, 349))
        ...
        spacerItem202 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.gridLayout_37.addItem(spacerItem202, 0, 1, 1, 1)
        spacerItem203 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_37.addItem(spacerItem203, 1, 0, 1, 1)
        ...
        spacerItem204 = QtWidgets.QSpacerItem(10, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_34.addItem(spacerItem204)
        ...
        spacerItem205 = QtWidgets.QSpacerItem(18, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_34.addItem(spacerItem205)
        self.verticalLayout_28.addLayout(self.horizontalLayout_34)
        self.horizontalLayout_35 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_35.setObjectName("horizontalLayout_35")
        spacerItem206 = QtWidgets.QSpacerItem(10, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_35.addItem(spacerItem206)
        ...
        spacerItem207 = QtWidgets.QSpacerItem(18, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_35.addItem(spacerItem207)
        self.verticalLayout_28.addLayout(self.horizontalLayout_35)
        self.horizontalLayout_36.addLayout(self.verticalLayout_28)
        spacerItem208 = QtWidgets.QSpacerItem(13, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_36.addItem(spacerItem208)
        ...
        spacerItem209 = QtWidgets.QSpacerItem(20, 17, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_69.addItem(spacerItem209)
        self.horizontalLayout_36.addLayout(self.verticalLayout_69)
        spacerItem210 = QtWidgets.QSpacerItem(13, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_36.addItem(spacerItem210)
        ...
        spacerItem211 = QtWidgets.QSpacerItem(20, 17, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_66.addItem(spacerItem211)
        self.horizontalLayout_36.addLayout(self.verticalLayout_66)
        spacerItem212 = QtWidgets.QSpacerItem(13, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_36.addItem(spacerItem212)
        ...
        spacerItem213 = QtWidgets.QSpacerItem(20, 17, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_29.addItem(spacerItem213)
        self.horizontalLayout_36.addLayout(self.verticalLayout_29)
        spacerItem214 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_36.addItem(spacerItem214)
...
"}")
        ...
        self.verticalLayout_70.addItem(spacerItem215)
        ...
        self.horizontalLayout_68.addItem(spacerItem216)
...
"}")
        ...
        spacerItem217 = QtWidgets.QSpacerItem(13, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_68.addItem(spacerItem217)
...
"}")
        ...
        self.horizontalLayout_68.addItem(spacerItem218)
        ...
        spacerItem219 = QtWidgets.QSpacerItem(20, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.verticalLayout_70.addItem(spacerItem219)
        ...
        spacerItem220 = QtWidgets.QSpacerItem(20, 18, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_30.addItem(spacerItem220)
...
"}")
        ...
        spacerItem221 = QtWidgets.QSpacerItem(152, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_37.addItem(spacerItem221, 2, 2, 1, 1)
        spacerItem222 = QtWidgets.QSpacerItem(20, 174, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_37.addItem(spacerItem222, 3, 1, 1, 1)
...
"}")
        ...
        self.scrollAreaWidgetContents_11.setGeometry(QtCore.QRect(0, 0, 909, 413))
        ...
        self.gridLayout_38.addItem(spacerItem223, 0, 1, 1, 1)
        spacerItem224 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_38.addItem(spacerItem224, 1, 0, 1, 1)
        ...
        self.horizontalLayout_40.addItem(spacerItem225)
        ...
        self.horizontalLayout_38.addItem(spacerItem226)
        ...
        spacerItem227 = QtWidgets.QSpacerItem(10, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_39.addItem(spacerItem227)
        ...
        spacerItem228 = QtWidgets.QSpacerItem(10, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_41.addItem(spacerItem228)
        ...
        spacerItem229 = QtWidgets.QSpacerItem(28, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem230 = QtWidgets.QSpacerItem(10, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_42.addItem(spacerItem230)
        ...
        spacerItem231 = QtWidgets.QSpacerItem(10, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_43.addItem(spacerItem231)
        ...
        spacerItem232 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_32.addItem(spacerItem232)
        self.horizontalLayout_44.addLayout(self.verticalLayout_32)
        spacerItem233 = QtWidgets.QSpacerItem(28, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_44.addItem(spacerItem233)
        ...
        spacerItem234 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_33.addItem(spacerItem234)
        self.horizontalLayout_44.addLayout(self.verticalLayout_33)
        spacerItem235 = QtWidgets.QSpacerItem(28, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_44.addItem(spacerItem235)
        ...
        spacerItem236 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_34.addItem(spacerItem236)
        self.horizontalLayout_44.addLayout(self.verticalLayout_34)
        spacerItem237 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_44.addItem(spacerItem237)
...
"}")
        ...
        spacerItem238 = QtWidgets.QSpacerItem(20, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.verticalLayout_67.addItem(spacerItem238)
        ...
        self.horizontalLayout_69.addItem(spacerItem239)
...
"}")
        ...
        spacerItem240 = QtWidgets.QSpacerItem(13, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_69.addItem(spacerItem240)
...
"}")
        ...
        self.horizontalLayout_69.addItem(spacerItem241)
        ...
        spacerItem242 = QtWidgets.QSpacerItem(20, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.verticalLayout_67.addItem(spacerItem242)
        ...
        self.verticalLayout_35.addItem(spacerItem243)
...
"}")
        ...
        spacerItem244 = QtWidgets.QSpacerItem(8, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_38.addItem(spacerItem244, 2, 2, 1, 1)
        spacerItem245 = QtWidgets.QSpacerItem(20, 95, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_38.addItem(spacerItem245, 3, 1, 1, 1)
...
"}")
        ...
        self.scrollAreaWidgetContents_12.setGeometry(QtCore.QRect(0, 0, 917, 392))
        ...
        spacerItem246 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.gridLayout.addItem(spacerItem246, 0, 1, 1, 1)
        spacerItem247 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem247, 1, 0, 1, 1)
...
"}")
        ...
        spacerItem248 = QtWidgets.QSpacerItem(20, 18, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_38.addItem(spacerItem248)
        ...
        spacerItem249 = QtWidgets.QSpacerItem(100, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_59.addItem(spacerItem249)
...
"}")
        ...
        spacerItem250 = QtWidgets.QSpacerItem(20, 18, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_37.addItem(spacerItem250)
        ...
        spacerItem251 = QtWidgets.QSpacerItem(20, 30, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.verticalLayout_58.addItem(spacerItem251)
...
"}")
        ...
        spacerItem252 = QtWidgets.QSpacerItem(20, 18, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_39.addItem(spacerItem252)
        ...
        spacerItem253 = QtWidgets.QSpacerItem(100, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_60.addItem(spacerItem253)
...
"}")
        ...
        spacerItem254 = QtWidgets.QSpacerItem(20, 18, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_40.addItem(spacerItem254)
        ...
        self.horizontalLayout_77.addItem(spacerItem255)
...
"}")
        ...
        spacerItem256 = QtWidgets.QSpacerItem(146, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem256, 2, 2, 1, 1)
        spacerItem257 = QtWidgets.QSpacerItem(20, 277, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout.addItem(spacerItem257, 3, 1, 1, 1)
...
"}")
        ...
        spacerItem258 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.gridLayout_40.addItem(spacerItem258, 0, 1, 1, 1)
        spacerItem259 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_40.addItem(spacerItem259, 1, 0, 1, 1)
...
"}")
        ...
        spacerItem260 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_40.addItem(spacerItem260, 2, 3, 1, 1)
        spacerItem261 = QtWidgets.QSpacerItem(20, 275, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_40.addItem(spacerItem261, 3, 2, 1, 1)
...
"}")
        ...
        self.scrollAreaWidgetContents_14.setGeometry(QtCore.QRect(0, 0, 908, 413))
        ...
        spacerItem262 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.gridLayout_41.addItem(spacerItem262, 0, 1, 1, 1)
        spacerItem263 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_41.addItem(spacerItem263, 1, 0, 1, 1)
        ...
        spacerItem264 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.verticalLayout_64.addItem(spacerItem264)
        self.horizontalLayout_82 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_82.setObjectName("horizontalLayout_82")
        spacerItem265 = QtWidgets.QSpacerItem(180, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_82.addItem(spacerItem265)
...
"}")
        ...
        spacerItem266 = QtWidgets.QSpacerItem(60, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_82.addItem(spacerItem266)
...
"}")
        ...
        spacerItem267 = QtWidgets.QSpacerItem(180, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_82.addItem(spacerItem267)
        self.verticalLayout_64.addLayout(self.horizontalLayout_82)
        spacerItem268 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.verticalLayout_64.addItem(spacerItem268)
        ...
        spacerItem269 = QtWidgets.QSpacerItem(155, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_41.addItem(spacerItem269, 2, 3, 1, 1)
        spacerItem270 = QtWidgets.QSpacerItem(20, 214, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_41.addItem(spacerItem270, 3, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.newCountry_lb.setText(_translate("MainWindow", "Country:"))
        self.aircraft_lb.setText(_translate("MainWindow", "Platform/Aircraft:"))
        self.newRegistration_lb.setText(_translate("MainWindow", "Registration number:"))
        self.newManufacturer_lb.setText(_translate("MainWindow", "Manufacturer:"))
        ...
        self.deepFrontalStratiformCloudsCheck.setText(_translate("MainWindow", "Deep frontal stratiform clouds"))
