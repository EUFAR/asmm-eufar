...
if __name__ == '__main__':
    ...
    if not config_dict.get('LOG', 'path'):
        log_filename = os.path.join(path,'asmm_creator_log.out')
    else:
        log_filename = os.path.join(config_dict.get('LOG', 'path'),'asmm_creator_log.out')
    ...
    logging.info('**************************************************')
    logging.info('ASMM ' + _asmm_version + ' is starting ...')
    logging.info('**************************************************')
    launch_asmm_creator(path)
